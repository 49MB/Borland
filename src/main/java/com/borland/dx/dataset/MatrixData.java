...
public abstract class MatrixData {
  ...
  public abstract void updateStoreRow(long internalRow, RowVariant[] values,
      Column[] updateColumns) /*-throws DataSetException-*/;
  ...
  public abstract void changeColumn(int ordinal, Column oldColumn,
      Column newColumn) /*-throws DataSetException-*/;
  ...
  public abstract MatrixData restructure(StorageDataSet dataSet,
      Vector<CalcFieldsListener> calcListeners,
      Vector<CalcAggFieldsListener> calcAggFieldsListeners) /*-throws DataSetException-*/;
  
  public abstract boolean getNeedsRestructure() /*-throws DataSetException-*/;
  
  // ! public abstract void setNeedsRecalc(boolean recalc) /*-throws
  // DataSetException-*/;
  ...
  public abstract void setVariant(long internalRow, int ordinal, Variant value) /*-throws DataSetException-*/;
  ...
  public abstract void getOriginalVariant(long internalRow, int ordinal,
      Variant value) /*-throws DataSetException-*/;
  ...
  public abstract boolean dropIndex(SortDescriptor descriptor, Locale locale,
  ...
  public abstract void updateRow(long internalRow, Variant[] originalValues,
      RowVariant[] values, Column[] updateColumns) /*-throws DataSetException-*/;
  
  public abstract long replaceLoadedRow(long internalRow, ReadWriteRow row,
      RowVariant[] values, int status) /*-throws DataSetException-*/;
  ...
  public abstract void resetStatus(StorageDataSet dataSet, int rowStatus) /*-throws DataSetException-*/;
  
  public abstract void resetStatus(StorageDataSet dataSet, long row,
      int rowStatus) /*-throws DataSetException-*/;
  ...
  public abstract void recalc(StorageDataSet storageDataSet,
      AggManager aggManager) /*-throws DataSetException-*/;
  
  public abstract void getInsertedRows(StorageDataSet dataSet,
      DataSetView insertedDataSet) /*-throws DataSetException-*/;
  
  public abstract void getDeletedRows(StorageDataSet dataSet,
      DataSetView deletedDataSet) /*-throws DataSetException-*/;
  
  public abstract void getUpdatedRows(StorageDataSet dataSet,
      DataSetView updatedDataSet) /*-throws DataSetException-*/;
  
  public abstract MatrixData closeDataSet(StorageDataSet dataSet,
      int matrixDataType, AggManager aggManager, StorageDataSet fetchDataSet,
      int reason, boolean closeData) /*-throws DataSetException-*/;
  
  public abstract MatrixData setColumns(StorageDataSet dataSet, Column[] columns) /*-throws DataSetException-*/;
  
  // ! public abstract void deleteDataSet(StorageDataSet dataSet) /*-throws
  // DataSetException-*/;
  ...
  public abstract boolean indexExists(SortDescriptor descriptor,
      Vector<RowFilterListener> listener) /*-throws DataSetException-*/;
  ...
  public abstract void setCalcNames(String calcFieldsName,
      String calcAggFieldsName);
  ...
  // public static final void closeData(StorageDataSet dataSet, int reason,
  // boolean closeData)
  // /*-throws DataSetException-*/
  // {
  ...
  public static final void closeStorage(StorageDataSet dataSet, int reason,
      boolean closeData)
  /*-throws DataSetException-*/
  {
    // StorageDataSet.closeStorage() does not deal with recursion that occurs
    // when
    // AccessListeners notified of pending close (which causes recursion via
    // DataSet.close())
    // So call DataSet.close which protects against recursion via the "open"
    // state.
    //
  ...
  /*
   * public static boolean openStorage(StorageDataSet dataSet, DataSet view,
   * AccessEvent event) { return dataSet.openStorage(view, event); }
   */
  ...
  public static final void setTableName(StorageDataSet dataSet,
  ...
  public static final void setResolveOrder(StorageDataSet dataSet,
      String[] resolveOrder) {
    /*
     * if (!MatrixData.propSet(dataSet, PropSet.Resolvable)) if
     * (!MatrixData.propSet(dataSet, PropSet.Locale))
     */
  ...
  public static final void storeClassNeedsUpdate(StorageDataSet dataSet,
      String name) {
    StoreClassFactory currentFactory = dataSet.storeClassFactory;
    String currentName = currentFactory == null ? null : currentFactory
        .getClass().getName();
    if (MatrixData.propSet(dataSet, PropSet.StoreClassFactory)
        && !identifierEquals(currentName, name)) {
      dataSet.needsPropertyUpdate = true;
    }
  }
  
  public static final void setStoreClassFactory(StorageDataSet dataSet,
      StoreClassFactory factory) {
  ...
  // ! public static final void addChangeListener(StorageDataSet dataSet,
  // DataSet listener)
  // ! /*-throws DataSetException-*/
  // ! {
  ...
  // ! public static final void removeChangeListener(StorageDataSet dataSet,
  // DataSet listener) {
  // ! dataSet.removeStorageDataChangeListener(listener);
  // ! }
  
  public static final void addUniqueColumns(StorageDataSet dataSet,
      Column[] columns, Column[] orderColumns, boolean reconcile)
  /*-throws DataSetException-*/
  {
  ...
  /*
   * public static final Column[] getColumns(StorageDataSet dataSet) { return
   * dataSet.columnList.cols; }
   */
  ...
  public static final StoreClassFactory getStoreClassFactory(
  ...
  public static final void updateRow(StorageDataSet dataSet, long internalRow,
      DataRow row, Column[] updateColumns)
  /*-throws DataSetException-*/
  {
  ...
  public static final void setStorageDataSet(DataSetView view,
      StorageDataSet sds)
  /*-throws DataSetException-*/
  {
  ...
  public static final ForeignKeyDescriptor[] getForeignKeyReferences(
      StorageDataSet dataSet)
  /*-throws DataSetException-*/
  {
  ...
  // return table.foreignKeyReferenceDescs != null || table.foreignKeyDescs !=
  // null;
  // }
  
  public static final void setForeignKeys(StorageDataSet dataSet,
      ForeignKeyDescriptor[] referenced, ForeignKeyDescriptor[] referencing)
  /*-throws DataSetException-*/
  {
  ...
  public static final void setConstraintName(StorageDataSet dataSet,
      SortDescriptor sort) {
  ...
  public static final void renameStoreName(StorageDataSet dataSet,
      String oldName, String newName) {
    dataSet.updateForeignKeyStoreName(oldName, newName);
  }
  
  public static final String[] createReferencedColumns(StorageDataSet dataSet,
  ...
  public static void setAutoIncConstraint(StorageDataSet dataSet, String name,
      boolean create) {
   ...
   * 
   * public static final void addReferenceForeignKey(StorageDataSet dataSet,
   * ForeignKeyDescriptor desc) { StorageDataSet table =
   * desc.openReferenceTableData(dataSet, dataSet.getStore());
