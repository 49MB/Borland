...
public class LocalDateUtil {
  ...
  public static void setAsLocalDate(Variant variant, long longValue,
      Calendar cal) {
  ...
  public static void setAsLocalTime(Variant variant, long longValue,
      Calendar cal) {
    longValue /= 1000;
   ...
   * @param variant
   *          the date is set in this <code>Variant</code> object
   */
  public static void setLocalDateAsLong(Variant variant, String value) {
    ...
    variant.setDate(new java.sql.Date(gc.getTimeInMillis()));
  }
   ...
   * @param variant
   *          the time is set in this <code>Variant</code> object
   */
  public static void setLocalTimeAsLong(Variant variant, String value) {
    ...
    variant.setTime(new java.sql.Time(gc.getTimeInMillis()));
  }
}
