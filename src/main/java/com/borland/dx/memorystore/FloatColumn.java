...
// Not public.
//
class FloatColumn extends DataColumn {

  public FloatColumn(NullState nullState) {
    super(nullState);
    vector        = new float[InitialSize];
  ...
  final void copy(int source, int dest) {
   ...
   final void  grow(int newLength) {
    ...
    float newVector[] = new float[newLength];
