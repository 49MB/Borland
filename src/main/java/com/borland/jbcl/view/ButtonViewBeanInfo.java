...
public class ButtonViewBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public ButtonViewBeanInfo() {
    beanClass = ButtonView.class;
    propertyDescriptors = new String[][] {
      ...
      {"model",         "Opaque setting (false == transparent)", "getModel", "setModel"},     //RES NORES,BI_opaque,NORES,NORES
