...
/**
 * Implementers of SingletonView have the simple properties that exist on all views
 * of a SingletonModel data source.
 */
public interface SingletonView extends SingletonModelView
{
 /**
  * The viewManager is a provider of itemPainters and itemEditors based on the
  * the data type.
  */
