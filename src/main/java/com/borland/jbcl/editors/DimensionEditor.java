...
public class DimensionEditor implements PropertyEditor {
  ...
  public String getAsText() {
    if (value == null)
      return null;
    return String.valueOf(value.width) + ", " + value.height;  
  }

  public String getJavaInitializationString() {
    if (value == null)
      return null;
    return "new Dimension(" + value.width + ", " + value.height + ")";  
  }
  ...
  public void setAsText(String text) throws java.lang.IllegalArgumentException {
    ...
    try {
      value = new Dimension(Integer.parseInt(argv[0]), Integer.parseInt(argv[1]));
    }
