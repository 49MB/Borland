...
/**
 * Broker of ItemPainters and ItemEditors to views of matrix data structures.
 */
public interface MatrixViewManager
{
  /**
   * Returns at ItemPainter object for the specified row, column and data value.
   ...
   */
  public ItemPainter getPainter(int row, int column, Object data, int state);

  /**
   * Returns at ItemEditor object for the specified row, column and data value.
   * Implementing classes can optionally switch off of any (all/some/none) of the
   ...
   */
  public ItemEditor getEditor(int row, int column, Object data, int state);
}
