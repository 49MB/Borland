...
/**
 * Broker of ItemPainters and ItemEditors to views of graph data structures.
 */
public interface GraphViewManager
{
  /**
   * Returns at ItemPainter object for the specified GraphLocation/data value.
   ...
   * @param node The GraphLocation to be painted.
  ...
  /**
   * Returns at ItemEditor object for the specified GraphLocation/data value.
   * Implementing classes can optionally switch off of any (all/some/none) of the
   * passed values to select the appropriate ItemEditor.
   * @param node The GraphLocation to be edited.
