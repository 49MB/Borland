...
public class VectorSelectionEvent extends SelectionEvent implements Serializable
{
  ...
  public VectorSelection getSelection()  { return selection; }
  ...
  public void dispatch(EventListener listener) {
    switch (getID()) {
      case ITEM_CHANGE:      ((VectorSelectionListener)listener).selectionItemChanged(this);  break;
      case RANGE_CHANGE:     ((VectorSelectionListener)listener).selectionRangeChanged(this); break;
      case SELECTION_CHANGE: ((VectorSelectionListener)listener).selectionChanged(this);      break;
      default:
        Diagnostic.fail();
        break;
    }
  ...
  private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
    ...
    if (data instanceof VectorSelection)
      selection = (VectorSelection)data;
  }
