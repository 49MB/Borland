...
/**
 * The VectorSelection interface provides read access to a selection pool
 * for a VectorModel model.
 * <P>
...
public interface VectorSelection
{
   ...
   */
  void addSelectionListener(VectorSelectionListener listener);

  /**
   * Removes a selection event listener from the selection pool.
   */
  void removeSelectionListener(VectorSelectionListener listener);
}
