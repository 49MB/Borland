...
/**
 * A multicaster for SingletonModelEvents.
 */
public class SingletonModelMulticaster implements SingletonModelListener
{
   ...
   */
  public int find(SingletonModelListener listener) {
    if (listeners != null ) {
   ...
   *
   */
  public synchronized final void add(SingletonModelListener listener) {
    if (find(listener) < 0) {
      SingletonModelListener[] newListeners;

      if (listeners == null)
        newListeners = new SingletonModelListener[1];
      else {
        newListeners = new SingletonModelListener[listeners.length+1];
   ...
   *
   */
  public synchronized final void remove(SingletonModelListener listener) {
    ...
    if (index > -1) {
      ...
      if (listeners.length == 1)
        ...
        SingletonModelListener[] newListeners = new SingletonModelListener[listeners.length-1];
