...
/**
 * NullGraphSelection implements a no-selection WritableGraphSelection
 */
public class NullGraphSelection implements WritableGraphSelection, Serializable
{
  public boolean contains(GraphLocation location) { return false; }
  public int getCount() { return 0; }
  public GraphLocation[] getAll() { return new GraphLocation[0]; }
