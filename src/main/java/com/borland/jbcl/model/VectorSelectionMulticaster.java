...
/**
 * A multicaster for VectorSelectionEvents.
 */
public class VectorSelectionMulticaster implements VectorSelectionListener
{
  // VectorSelectionListener Implementation
   ...
   */
  public int find(VectorSelectionListener listener) {
    if (listeners != null ) {
   ...
   *
   */
  public synchronized final void add(VectorSelectionListener listener) {
    if (find(listener) < 0) {
      VectorSelectionListener[] newListeners;

      if (listeners == null)
        newListeners = new VectorSelectionListener[1];
      else {
        newListeners = new VectorSelectionListener[listeners.length+1];
   ...
   *
   */
  public synchronized final void remove(VectorSelectionListener listener) {
    ...
    if (index > -1) {
      ...
      if (listeners.length == 1)
        ...
        VectorSelectionListener[] newListeners = new VectorSelectionListener[listeners.length-1];
