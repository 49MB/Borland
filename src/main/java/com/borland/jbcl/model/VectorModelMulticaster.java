...
/**
 * A multicaster for VectorModelEvents.
 */
public class VectorModelMulticaster implements VectorModelListener
{
   ...
   */
  public int find(VectorModelListener listener) {
    if (listeners != null ) {
   ...
   *
   */
  public synchronized final void add(VectorModelListener listener) {
    if (find(listener) < 0) {
      VectorModelListener[] newListeners;

      if (listeners == null)
        newListeners = new VectorModelListener[1];
      else {
        newListeners = new VectorModelListener[listeners.length+1];
   ...
   *
   */
  public synchronized final void remove(VectorModelListener listener) {
    ...
    if (index > -1) {
      ...
      if (listeners.length == 1)
        ...
        VectorModelListener[] newListeners = new VectorModelListener[listeners.length-1];
