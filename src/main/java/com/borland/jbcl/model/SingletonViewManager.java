...
/**
 * Broker of ItemPainters and ItemEditors to views of singleton data structures.
 */
public interface SingletonViewManager
{
  /**
   * Returns at ItemPainter object for the specified data value.
  ...
  /**
   * Returns at ItemEditor object for the specified data value.
   * Implementing classes can optionally switch off of any (all/some/none) of the
