...
/**
 * A multicaster for MatrixModelEvents.
 */
public class MatrixModelMulticaster implements MatrixModelListener
{
   ...
   */
  public int find(MatrixModelListener listener) {
    if (listeners != null ) {
   ...
   *
   */
  public synchronized final void add(MatrixModelListener listener) {
    if (find(listener) < 0) {
      MatrixModelListener[] newListeners;

      if (listeners == null)
        newListeners = new MatrixModelListener[1];
      else {
        newListeners = new MatrixModelListener[listeners.length+1];
   ...
   *
   */
  public synchronized final void remove(MatrixModelListener listener) {
    ...
    if (index > -1) {
      ...
      if (listeners.length == 1)
        ...
        MatrixModelListener[] newListeners = new MatrixModelListener[listeners.length-1];
