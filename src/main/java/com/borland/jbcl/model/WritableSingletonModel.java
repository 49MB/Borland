...
/**
 * The WritableSingletonModel interface supplies read/write access to unary (singleton) data.
 */
public interface WritableSingletonModel extends SingletonModel
{
   ...
   * @return True if the value can be set, fasle if not.
   */
  public boolean canSet(boolean startEditing);

  /**
   * Sets data object.
   * @param data The new data object to put in this container.
   */
  public void set(Object data);

  /**
   * Notify all model listeners that the data object was touched.
   */
  public void touched();
   ...
   * If true, events are enabled, and a CONTENT_CHANGED
