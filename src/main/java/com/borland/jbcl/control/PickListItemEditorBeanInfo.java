...
public class PickListItemEditorBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public PickListItemEditorBeanInfo() {
    beanClass = PickListItemEditor.class;
    ...
    propertyDescriptors = new String[][] {
      ...
      {"cachePickList",    "Enabled state", "isCachePickList", "setCachePickList"},     //RES NORES,BI_enabled,NORES,NORES
