...
public class LocatorControlBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public LocatorControlBeanInfo() {
    beanClass = LocatorControl.class;
    ...
    propertyDescriptors = new String[][] {
      ...
      {"caseSensitive",   "Case sensitive locate", "isCaseSensitive", "setCaseSensitive"},     //RES NORES,BI_Locator_caseSensitive,NORES,NORES
