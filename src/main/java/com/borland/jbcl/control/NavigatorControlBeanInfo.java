...
public class NavigatorControlBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public NavigatorControlBeanInfo() {
    beanClass = NavigatorControl.class;
...
//      {"imageBase",     Res._BI_ButtonBar_imageBase, "getImageBase", "setImageBase", com.borland.jbcl.editors.DirectoryEditor.class.getName()}, // String
      {"imageFirst",    "Image left/above label", "isImageFirst", "setImageFirst"},     //RES NORES,BI_ButtonControl_imageFirst,NORES,NORES
//      {"imageNames",    Res._BI_ButtonBar_imageNames, "getImageNames", "setImageNames"}, // String[]
//      {"labels",        Res._BI_ButtonBar_labels, "getLabels", "setLabels"}, // String[]
