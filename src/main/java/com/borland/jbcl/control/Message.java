...
public class Message implements WindowListener, java.io.Serializable
{
  ...
  public Message(Frame frame, String title, String msg) {
    ...
    this.message = msg;
    if (frame != null) {
      dialog = new MessageDialog(frame, title, msg);
  ...
  public void setVisible(boolean visible) {
    if (visible) {
      if (dialog == null) {
        ...
        dialog = new MessageDialog(frame, title, message);
        if (buttonSet >= 0)
  ...
  protected int buttonSet = MessageDialog.OK;
