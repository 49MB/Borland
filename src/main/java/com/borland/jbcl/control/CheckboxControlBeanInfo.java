...
public class CheckboxControlBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public CheckboxControlBeanInfo() {
    beanClass = CheckboxControl.class;
    ...
    propertyDescriptors = new String[][] {
      ...
      {"checkboxGroup", "Associated checkbox group", "getCheckboxGroup", "setCheckboxGroup"},     //RES NORES,BI_CheckboxControl_cbGroup,NORES,NORES
      {"checked",       "Checked state", "isChecked", "setChecked"},     //RES NORES,BI_CheckboxControl_checked,NORES,NORES
