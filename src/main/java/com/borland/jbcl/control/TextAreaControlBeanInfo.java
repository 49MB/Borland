...
public class TextAreaControlBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public TextAreaControlBeanInfo() {
    beanClass = TextAreaControl.class;
    ...
    propertyDescriptors = new String[][] {
      ...
      {"rows",            "Number of rows", "getRows", "setRows"},     //RES NORES,BI_Text_rows,NORES,NORES
      ...
      {"text",            "Text string", "getText", "setText", com.borland.jbcl.editors.MultilineTextEditor.class.getName()},     //RES NORES,BI_text,NORES,NORES
