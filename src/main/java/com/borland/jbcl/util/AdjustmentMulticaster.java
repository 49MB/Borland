...
public class AdjustmentMulticaster implements AdjustmentListener
{
  ...
  public final void dispatch(AdjustmentEvent e) {
    ...
    if (listenersCopy != null) {
      ...
      for (int index = 0; index < count; ++index) {
        ...
        listenersCopy[index].adjustmentValueChanged(e);
   ...
   */
  public int find(AdjustmentListener listener) {
    if (listeners != null ) {
   ...
   *
   */
  public synchronized final void add(AdjustmentListener listener) {
    if (find(listener) < 0) {
      AdjustmentListener[] newListeners;

      if (listeners == null)
        newListeners = new AdjustmentListener[1];
      else {
        newListeners = new AdjustmentListener[listeners.length+1];
   ...
   *
   */
  public synchronized final void remove(AdjustmentListener listener) {
    ...
    if (index > -1) {
      ...
      if (listeners.length == 1)
        ...
        AdjustmentListener[] newListeners = new AdjustmentListener[listeners.length-1];
