...
public class ExceptionChain implements java.io.Serializable {
   ...
   * {@link com.borland.jb.util.ChainedException} object (the linked list of
   * exceptions).
   * 
   * @param ex
  ...
  private void printStackTrace(ExceptionChain exChain,
      java.io.PrintWriter writer) {
    if (exChain != null && exChain.next != null)
      exChain.printStackTrace(exChain.next, writer);
    if (ex != null && !(ex instanceof DataSetException))
