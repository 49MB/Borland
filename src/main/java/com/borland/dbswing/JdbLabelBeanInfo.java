...
/**
 * <p>BeanInfo for <code>JdbLabel</code>.</p>
 */

public class JdbLabelBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public JdbLabelBeanInfo() {
    beanClass = JdbLabel.class;
...
//      {"UI",                     Res._BI_UI, "", "", null, "true", "true"},
      ...
      // com.borland.dbswing.JdbLabel properties
