...
/**
 * <p>BeanInfo for <code>DBListDataBinder</code>.</p>
 */

public class DBListDataBinderBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public DBListDataBinderBeanInfo() {
    beanClass = DBListDataBinder.class;
...
//    {"PropertyName", "Short Description", "ReadMethod", "WriteMethod", "PropertyEditor", "Expert", "Hidden"}
      ...
      {"jList",                  "JList or subclass of JList to bind to data", "", ""},     //RES NORES,BI_DBListDB_jList,NORES,NORES
//      {"listModel",              Res._BI_DBListDB_listModel, "", "", null, "true", "true"},
//      {"listSelectionModel",     Res._BI_DBListDB_listSelectionModel, "", "", null, "true", "true"},
