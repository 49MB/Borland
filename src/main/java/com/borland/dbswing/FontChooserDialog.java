...
public class FontChooserDialog extends JDialog implements ActionListener,
   ...
   * 
   */
  private static final long serialVersionUID = 2457191409579510394L;
  private final JComboBox fontNameComboBox = new JComboBox();
  private final JdbLabel fontNameLabel = new JdbLabel();
  private final JComboBox fontSizeComboBox = new JComboBox();
  private final JdbLabel fontSizeLabel = new JdbLabel();
  private Border border1;
  private TitledBorder titledBorder1;
  private final JTextArea sampleTextArea = new JTextArea() {
    /**
     * 
     */
    private static final long serialVersionUID = -1828375037499861257L;
  ...
  private final JPanel fontNamePanel = new JPanel();
  ...
  private final JPanel mainFontPanel = new JPanel();
  private final GridBagLayout gridBagLayout1 = new GridBagLayout();
  private final JPanel innerButtonPanel = new JPanel();
  private final RepeatButton okButton = new RepeatButton();
  private final RepeatButton cancelButton = new RepeatButton();
  private final GridLayout gridLayout1 = new GridLayout();
  private final JPanel outerButtonPanel = new JPanel();
  
  private GraphicsEnvironment graphicsEnvironment;
  private boolean okPressed = false;
  
  /**
   * Constructs a <code>FontChooser</code>Dialog with a specified frame, a
   * string that appears as the title of the dialog box. The third parameter is
   * deprecated. The dialog is always modal.
   */
  ...
  /**
   * Constructs a modal <code>FontChooser</code>Dialog with no title on the
   * title bar.
   */
  ...
  void jbInit() throws Exception {
    ...
    fontSizeComboBox.setModel(new DefaultComboBoxModel(new String[] { "8.0",
        "10.0", "12.0", "14.0", "16.0", "18.0", "24.0", "36.0", "48.0" }));
  ...
  public void itemStateChanged(ItemEvent e) {
    if (e.getSource() == fontSizeComboBox) {
      ...
      if (e.getID() != ItemEvent.DESELECTED) {
        ...
        // workaround for Win32 JDK bug where font styles aren't always
        // correctly used
        ...
        sampleTextArea.setFont(sizelessFont.deriveFont(Float
            .parseFloat(fontSizeComboBox.getSelectedItem().toString())));
      }
    }
    updateOkButton();
  }
  ...
  public void setSelectedFont(Font selectedFont) {
    ...
    for (int index = 0; index < model.getSize(); index++) {
      ...
      if (availFont.equals(selectedFont)
          || ((availFont.getFontName().toUpperCase()
              .indexOf(fontName.toUpperCase()) != -1)
              && (selectedFont.isBold() == (availFont.isBold() || availFont
                  .getFontName().toUpperCase()
                  .indexOf(Res._BoldFont.toUpperCase()) != -1)) && (selectedFont
              .isItalic() == (availFont.isItalic() || availFont.getFontName()
              .toUpperCase().indexOf(Res._ItalicFont.toUpperCase()) != -1)))) {
