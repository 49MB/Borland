...
/**
 * <p>BeanInfo for <code>JdbTree</code>.</p>
 */

public class JdbTreeBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public JdbTreeBeanInfo() {
    beanClass = JdbTree.class;
...
//      {"layout",                 Res._BI_layout, "", "", null, "true", "true"},
      ...
      {"editable",               "whether the tree is editable", "", "", null, "true"},     //RES NORES,BI_JTree_editable,NORES,NORES,NORES
