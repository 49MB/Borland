...
/**
 * <p>BeanInfo for <code>JdbTextArea</code>.</p>
 */

public class JdbTextAreaBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public JdbTextAreaBeanInfo() {
    beanClass = JdbTextArea.class;
...
//      {"UI",                     Res._BI_UI, "", "", null, "true", "true"},
      ...
      {"columns",                "number of columns to display", "", ""},     //RES NORES,BI_JText_columns,NORES,NORES
      {"lineWrap",               "automatically wrap lines", "", ""},     //RES NORES,BI_JText_lineWrap,NORES,NORES
      {"rows",                   "number of rows to display", "", ""},     //RES NORES,BI_JText_rows,NORES,NORES
      {"tabSize",                "tab size", "", ""},     //RES NORES,BI_JText_tabSize,NORES,NORES
      {"wrapStyleWord",          "wrap words or wrap characters", "", ""},     //RES NORES,BI_JText_wrapStyleWord,NORES,NORES
...
//      {"columnNameURL",          Res._BI_JdbText_columnNameURL, "", ""},
