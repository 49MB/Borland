...
/**
 * <p>
 * Navigates a <code>DataSet</code> by synchronizing a <code>JTree</code>'s
 * selected value with a <code>DataSet Column</code> value.
 * <code>DBTreeNavBinder</code> is the default binder used by
 * <code>JdbNavTree</code>.
 * </p>
 * 
 * <p>
 * There are two other ways to use a <code>DBTreeNavBinder</code> to navigate a
 * <code>DataSet</code>. The easiest way is to simply set the <code>jTree</code>
 * property to a <code>JTree</code> (or subclass of <code>JTree</code>).
 * Alternatively, any component using a <code>TreeSelectionModel</code> can be
 * set as <code>DBTreeNavBinder</code>'s <code>treeSelectionModel</code>
 * property (or <code>DBTreeNavBinder</code> can be added as a
 * <code>TreeSelectionListener</code> to the component). If you take this
 * approach, however, you are responsible for opening the <code>DataSet</code>
 * from which to read data.
 * </p>
 * 
 * <p>
 * In either case, you also need to set <code>DBTreeNavBinder</code>'s
 * <code>dataSet</code> and <code>columnName</code> properties to indicate the
 * <code>DataSet</code> and <code>Column</code> in which the tree will navigate.
 * </p>
 * 
 * <p>
 * If you set the <code>JTree</code> property, <code>DBTreeNavBinder</code> will
 * also bind the <code>background, foreground</code>, and <code>font</code>
 * properties from those defined on <code>Column columnName</code> (if defined),
 * unless already explicitly set on the <code>JTree</code> itself.
 * </p>
 * 
 * <p>
 * <code>DBTreeNavBinder</code> can only synchronize values between the tree and
 * <code>DataSet</code> if the <code>TreeNodes</code> are of actual type
 * <code>javax.swing.tree.DefaultMutableTreeNode</code>, since the
 * <code>DefaultMutableTreeNode.getUserObject()</code> method is used to read
 * values from the tree. The object returned by <code>getUserObject()</code> is
 * assumed to be of the same data type as that of <code>Column columnName</code>
 * .
 * </p>
 * 
 * <p>
 * Unlike <code>DBTreeDataBinder</code>, which writes values into the current
 * row of a <code>DataSet</code>, <code>DBTreeNavBinder</code> locates and
 * navigates to a row in the <code>DataSet</code> with a <code>Column</code>
 * value matching the currently selected node in the tree.
 * </p>
 * 
 * <p>
 * If the selected value in the tree cannot be located in the
 * <code>DataSet</code>, <code>DBTreeNavBinder</code> displays a confirmation
 * dialog explaining that this is the case. If the current value in the
 * <code>DataSet</code> cannot be found in the tree, the tree's selection is
 * cleared.
 * </p>
 * 
 * <p>
 ...
 */
public class DBTreeNavBinder implements TreeSelectionListener, AccessListener,
    PropertyChangeListener, NavigationListener, DataChangeListener,
    ColumnAware, TreeModelListener, Designable, DBDataBinder,
    java.io.Serializable, FocusListener {
  
  /**
   * <p>
   * Constructs a <code>DBTreeNavBinder</code> component. Calls the
  ...
  /**
   * <p>
   * Creates a <code>DBTreeNavBinder</code> that navigates the specified
   * <code>JTree</code>. Calls the <code>null</code> constructor of its
   * superclass.
   * </p>
   * 
   * @param jTree
   *          The <code>JTree</code> which this <code>DBTreeNavBinder</code>
   *          will navigate.
   */
  ...
  /**
   * <p>
   * Sets the <code>JTree</code> used to navigate the <code>DataSet</code>.
   * </p>
   * 
   * <p>
   ...
   * 
   * @param jTree
   *          The <code>JTree</code> used to navigate the <code>DataSet</code>.
   * @see #getJTree
   */
  ...
  /**
   * <p>
   * Returns the <code>JTree</code> used to navigate the <code>DataSet</code>.
   * </p>
   * 
   * <p>
   * See the class description for more information.
  ...
  /**
   * <p>
   * Sets the <code>TreeSelectionModel</code> used to determine when navigation
   * in the <code>DataSet</code> should occur.
   * </p>
   * 
   * <p>
   * See the class description for more information.
   ...
   *          The <code>TreeSelectionModel</code> used to determine when
   *          navigation in the <code>DataSet</code> should occur.
  ...
  /**
   * <p>
   * Returns the <code>TreeSelectionModel</code> used to determine when
   * navigation in the <code>DataSet</code> should occur.
   * </p>
   * 
   * <p>
   ...
   * </p>
   * 
   * @return The <code>TreeSelectionModel</code> used to determine when
   *         navigation in the <code>DataSet</code> should occur.
  ...
  /**
   * <p>
   * Sets the <code>TreeModel</code> containing data to navigate in the
   * <code>DataSet</code>.
   * </p>
   * 
   * @param treeModel
   *          The <code>TreeModel</code> containing data to navigate in the
   *          <code>DataSet</code>.
   * @see #getTreeModel
   */
  ...
  /**
   * <p>
   * Returns the <code>TreeModel</code> containing data to navigate in the
   * <code>DataSet</code>.
   * </p>
   * 
   * @return The <code>TreeModel</code> containing data to navigate in the
   *         <code>DataSet</code>.
   * @see #setTreeModel
   */
  ...
  /**
   * <p>
   * Sets the <code>DataSet</code> to which values are written and from which
   * values are read.
   * </p>
   * 
   * @param dataSet
  ...
  /**
   * <p>
   * Returns the <code>DataSet</code> to which values are written and from which
   * values are read.
   * </p>
   * 
  ...
  /**
   * <p>
   * Sets the column name of the <code>DataSet</code> to which values are
   * written and from which values are read.
   * </p>
   * 
   * @param columnName
  ...
  /**
   * <p>
   * Returns the column name of the <code>DataSet</code> to which values are
   * written and from which values are read.
   * </p>
   * 
  ...
  /**
   * <p>
   * Sets whether to ignore internal node values during selection changes and
   * when locating nodes by value.
   * </p>
   * 
   * @param useLeafNodesOnly
   *          If <code>true</code>, ingores internal node values.
  ...
  /**
   * <p>
   * Returns whether to ignore internal node values during selection changes and
   * when locating nodes by value.
   * </p>
   * 
  ...
  protected void updateSelectedTreeValue() {
    if (!ignoreValueChange) {
      ...
      if (columnAwareSupport.isValidDataSetState()) {
        TreePath selectionPath = findUserObject(
            (DefaultMutableTreeNode) treeModel.getRoot(), columnAwareSupport
                .getVariant().getAsObject());
        ...
        if (selectionPath == null) {
          if (mode == CLEAR_VALUE && !columnAwareSupport.isNull()) {
            ...
            if (jTree != null
                && !columnAwareSupport.getVariant().isUnassignedNull()) {
  ...
  /**
   * <p>
   * Searches for the user object within the tree rooted at node using a
   * depth-first search algorithm. The <code>equals()</code> method of the
   * node's user object is called to determine whether the two user objects are
   * equal.
   * </p>
   * 
   * <p>
   * Returns the <code>TreePath</code> to the specified user object if found,
   * otherwise returns <code>null</code>. You can override this method to
   * implement your own tree search algorithm.
   * </p>
   * 
   * @param node
   *          The node where the tree is rooted.
   * @param object
  ...
  public void valueChanged(TreeSelectionEvent e) {
    if (!ignoreValueChange && e.getNewLeadSelectionPath() != null) {
      TreeNode node = (TreeNode) treeSelectionModel.getSelectionPath()
      ...
      if (node instanceof DefaultMutableTreeNode
        ...
        if (columnAwareSupport.isValidDataSetState()) {
          try {
            if (locateRow == null) {
              locateRow = new DataRow(columnAwareSupport.dataSet,
                  columnAwareSupport.getColumnName());
              variant = new Variant();
            }
            variant.setAsObject(
                ((DefaultMutableTreeNode) node).getUserObject(),
                columnAwareSupport.getColumn().getDataType());
            ...
            if (!columnAwareSupport.dataSet.locate(locateRow, Locate.FIRST)) {
              JOptionPane.showMessageDialog(jTree, Res._NavLocateFailed, null,
  ...
  public void dataChanged(DataChangeEvent event) {
    ...
    boolean affectedOurRow = ((affectedRow == columnAwareSupport.dataSet
        .getRow()) || affectedRow == -1)
        && event.isColumnAffected(columnAwareSupport.columnName);
    if (affectedOurRow) {
      updateSelectedTreeValue();
    }
  }
  ...
  /**
   * <p>
   * Sets the <code>font, foreground</code>, and <code>background</code>
   * properties from the column properties of the same names if these properties
    ...
    if (jTree != null && jTree.isDisplayable()) {
      ...
      if (columnAwareSupport.isValidDataSetState()) {
        ...
        if (jTree.getCellEditor() == null
            && column.getItemEditor() instanceof TreeCellEditor) {
          jTree.setCellEditor((TreeCellEditor) column.getItemEditor());
        }
        
        if (jTree.getCellRenderer() == null
            && column.getItemPainter() instanceof TreeCellRenderer) {
  ...
  public void treeNodesChanged(TreeModelEvent e) {
    if (jTree != null
        && e.getTreePath().equals(jTree.getSelectionPath().getParentPath())) {
      int targetIndex = ((TreeNode) jTree.getSelectionPath().getParentPath()
          .getLastPathComponent()).getIndex((TreeNode) jTree.getSelectionPath()
          .getLastPathComponent());
      int[] childIndices = e.getChildIndices();
      for (int i = 0; i < childIndices.length; i++) {
        if (childIndices[i] == targetIndex) {
          valueChanged(new TreeSelectionEvent(this, jTree.getSelectionPath(),
              false, jTree.getSelectionPath(), jTree.getSelectionPath()));
          break;
        }
      }
    }
  ...
  /**
   * <p>
   * The <code>treeSelectionModel</code> containing current tree selection.
   * </p>
   */
  ...
  /**
   * <p>
   * The <code>treeModel</code> of the tree from which to read data.
   * </p>
   */
  ...
  /**
   * <p>
   * Flag indicating that <code>ListSelectionEvent</code> should be ignored.
   * </p>
   */
  ...
  /**
   * <p>
   * The current setting of unknown data value mode.
   * </p>
   */
  ...
  /**
   * Determines whether or not to ignore internal nodes for searches and
   * selection changes.
   */
