...
/**
 * <p>BeanInfo for <code>JdbNavList</code>.</p>
 */


public class JdbNavListBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public JdbNavListBeanInfo() {
    beanClass = JdbNavList.class;
