...
/**
 * <p>BeanInfo for <code>JdbTextPane</code>.</p>
 */

public class JdbTextPaneBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public JdbTextPaneBeanInfo() {
    beanClass = JdbTextPane.class;
...
//      {"UI",                     Res._BI_UI, "", "", null, "true", "true"},
      ...
      {"logicalStyle",            "logical style", "", "", null, "true", "true"},     //RES NORES,BI_JText_logicalStyle,NORES,NORES,NORES,NORES
      {"styledDocument",          "styled document", "", "", null, "true", "true"},     //RES NORES,BI_JText_styledDoc,NORES,NORES,NORES,NORES
