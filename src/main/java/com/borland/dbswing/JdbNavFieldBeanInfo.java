...
/**
 * <p>BeanInfo for <code>JdbNavField</code>.</p>
 */

public class JdbNavFieldBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public JdbNavFieldBeanInfo() {
    beanClass = JdbNavField.class;
...
//      {"UI",                     Res._BI_UI, "", "", null, "true", "true"},
      ...
      {"scrollOffset",           "offset (in pixels) from visible edge", "", ""},     //RES NORES,BI_JText_scrollOffset,NORES,NORES
      ...
      {"caseSensitive",          "always or conditionally do case-sensitive search", "", ""},     //RES NORES,BI_JdbNavField_caseSensitive,NORES,NORES
