...
/**
 * <p>BeanInfo for <code>JdbTextField</code>.</p>
 */

public class JdbTextFieldBeanInfo extends BasicBeanInfo implements java.io.Serializable
{
  public JdbTextFieldBeanInfo() {
    beanClass = JdbTextField.class;
...
//      {"columnNameURL",          Res._BI_JdbText_colNameURL, "", "", null, "true"},
