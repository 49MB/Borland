...
/**
 * <p>An extension of <code>JMenu</code>. It adds the
 * <code>textWithMnemonic</code> property for
 * internationalization support. The 
 * <code>textWithMnemonic</code> property accepts a text
 * string containing an ampersand (&) preceding the
...
public class IntlMenu extends JMenu {
 ...
 /**
  * <p>Creates an <code>IntlMenu</code>. Calls the constructor of this
  * class that takes a <code>String</code> for a parameter and
  * passes it an empty <code>String</code> (""). </p>
  *
  */
  public IntlMenu() {
    this("");   
 ...
 /**
  * <p>Creates an <code>IntlMenu</code> with the
  * specified text string. Calls the constructor of its
  * superclass that takes a a <code>String</code> for a
  * parameter.</p>
  *
  * @param s The text string for the menu. 
  */
  public IntlMenu(String s) {
    super(DBUtilities.excludeMnemonicSymbol(s));
  ...
  * specified text string. Calls the constructor of its
  * superclass that takes a a <code>String</code> for a
  * parameter passing it the specified String. The
  * <code>boolean</code> parameter is not currently
  * used, but is reserved for future use. </p>
  *
  * @param s The text string for the menu. 
  * @param b Not currently used. 
