...
/**
 * <p>
 * The default <code>TableCellEditor</code> for icons in a <a
 * href="JdbTable.html"><code>JdbTable</code></a>.
 * </p>
 * 
 * <p>
 * <code>TableImageEditor</code> displays a <code>JFileChooser</code> dialog
 * with a preview window showing the current cell value or the currently
 * selected file. To display the current cell value without providing the
 * ability to change its value, explicitly set the column's cell editor to <a
 * href="TableImageReadOnlyEditor.html"><code>TableImageReadOnlyEditor</code>
 * </a>.
 * </p>
 * 
 */
public class TableImageEditor extends JLabel implements TableCellEditor,
  ...
  private static ImagePreviewer imagePreviewer;
    ...
    if (file != null && file.exists()) {
      ...
      try {
        inputStream = new ByteArrayInputStream(
            DBUtilities.getByteArrayFromStream(new BufferedInputStream(
