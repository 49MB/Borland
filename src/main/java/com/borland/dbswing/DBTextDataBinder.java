...
/**
 * <p>
 * Maps data from a Swing text component to a <code>DataSet</code>
 * <code>Column</code> value. <code>DBTextDataBinder</code> is used internally
 * to make the <code>JdbTextField</code>, <code>JdbTextArea</code>,
 * <code>JdbTextPane</code>, and <code>JdbEditorPane</code> components
 * data-aware.
 * </p>
 * 
 * <p>
 * There are two ways to hook up a Swing text component to a
 * <code>DBTextDataBinder</code>:
 * </p>
 * 
 * <ul>
 * <li>
 * <p>
 * Set the <code>JTextComponent</code> property to any text component extending
 * the <code>JTextComponent</code> class, such as <code>JTextField</code>,
 * <code>JTextArea</code>, <code>JTextPane</code>, or <code>JEditorPane</code>.
 * </p>
 * <li>
 * <p>
 * Set <code>DBTextDataBinder's</code> <code>document</code> property to the
 * text component's model. Any component using a <code>Document</code> class as
 * its model can be made data-aware. Note that when using this approach you are
 * responsible for opening the <code>DataSet</code> before using it.
 * </p>
 * </ul>
 * 
 * <p>
 * In either case, you must set <code>DBTextDataBinder's</code>
 * <code>dataSet</code> and <code>columnName</code> properties to indicate the
 * <code>DataSet</code> and <code>Column</code> from which the text value is to
 * be read and to which it is to be written. <code>DBTextDataBinder</code>
 * ensures that the state of the text component is consistent with the current
 * value of the <code>DataSet</code> <code>Column</code> to which it is
 * attached.
 * </p>
 * 
 * <p>
 * If you set the <code>JTextComponent</code> property,
 * <code>DBTextDataBinder</code> also binds the <code>background</code>,
 * <code>foreground</code>, and <code>font</code> properties from those defined
 * on <code>Column</code> <code>columnName</code> (if defined), unless already
 * explicitly set on the <code>JTextComponent</code> itself.
 * </p>
 * 
 * <p>
 * Data typed into a component made data-aware by <code>DBTextDataBinder</code>
 * is not saved immediately to the <code>DataSet</code>. Rather, certain
 * conditions/events automatically cause the data to be put into the
 * <code>DataSet's</code> column. These two properties affect this behavior:
 * </p>
 * 
 * <ul>
 * <li><code>postOnFocusLost</code> - If <code>true</code>, data is saved to the
 * <code>DataSet</code> whenever the component bound by (or made data-aware by)
 * <code>DBTextDataBinder</code> loses focus.</li>
 * <li><code>postOnRowPosted</code> - If <code>true</code>, data is saved to the
 * <code>DataSet</code> whenever the current <code>DataSet</code> row is posted.
 * </li>
 * </ul>
 * 
 * <p>
 * <code>DBTextDataBinder</code> maps a small number of keys to special editing/
 * <code>DataSet</code> navigation functions for each bound text component. See
 * the notes in <a href="JdbTextField.html"><code>JdbTextField</code></a>, <a
 * href="JdbTextArea.html"><code>JdbTextArea</code></a>, <a
 * href="JdbTextPane.html"><code>JdbTextPane</code></a>, and <a
 * href="JdbEditorPane.html"><code>JdbEditorPane</code></a> for more details.
 * </p>
 * 
 * <p>
 * <code>DBTextDataBinder</code> provides each bound component a popup menu for
 * performing simple editing tasks, such as cutting, copying, or pasting
 * clipboard data. The popup menu also appears when the user presses
 * <KBD>Shift+F10</KBD> while the cursor is in the bound component. The menu
 * commands on the popup menu vary according to the capabilities of the bound
 * text component. The set of available menu commands can be customized via the
 * following properties:
 * </p>
 * 
 * <ul>
 * <li><code>enablePopupMenu</code> - Sets whether or not the popup menu is
 * displayable.</li>
 * <li><code>enableClearAll</code> - Sets whether the Clear All popup menu
 * command appears.</li>
 * <li><code>enableUndoRedo</code> - Sets whether the Undo and Redo menu
 * commands appear on the popup menu.</li>
 * <li><code>enableFileLoading</code> - Sets whether the File Open menu command
 * appears on the popup menu.</li>
 * <li><code>enableFileSaving</code> - Sets whether the File Save menu command
 * appears on the popup menu.</li>
 * <li><code>enableColorChange</code> - Sets whether the foreground and
 * background color setting menu commands appear on the popup menu.</li>
 * <li><code>enableFontChange</code> - Sets whether the font style setting menu
 * commands appear on the popup menu.</li>
 * <li><code>enableURLLoading</code> - Sets whether the Open URL menu command
 * appears on the popup menu (<code>JEditorPane</code> and its subclasses only).
 * </li>
 * </ul>
 * 
 * <p>
 * Each text component (subclass of <code>javax.swing.text.JTextComponent</code>
 * ) provides a set of built-in <code>javax.swing.Action</code> objects (which
 * have names like 'caret-forward', 'page-down', 'paste-from-clipboard', etc.)
 * returned by its <code>getActions()</code> method. The component's
 * look-and-feel (for example, <code>javax.swing.plaf.basic.BasicTextUI</code>)
 * calls the component's <code>getActions()</code> method to get a list of
 * <code>Actions</code> provided by the component, and maps the appropriate
 * keystroke to each <code>Action</code> by name. Thus, for example, in the
 * Windows look and feel class, the <KBD>right-arrow</KBD> keystroke is linked
 * to the action 'caret-forward', <KBD>PgDn</KBD> to 'page-down', and
 * <KBD>Ctrl+Ins</KBD> to 'paste-from-clipboard'.
 * </p>
 * 
 * <p>
 * Nearly all the functionality provided by <code>JdbTextField</code>,
 * <code>JdbTextArea</code>, <code>JdbTextPane</code>, and
 * <code>JdbEditorPane</code> is available as public <code>Actions</code> in
 * <code>DBTextDataBinder</code>. For example, <code>DBTextDataBinder</code>
 * provides a public <code>Action</code> named <code>LoadFileAction</code> that
 * a user can add to a menu, button, or toolbar to load a file into a
 * <code>JTextArea</code> as follows:
 * </p>
 * 
 * <pre>
 ...
 * 
 * <p>
 * When the button is pressed, the <code>LoadFileAction</code> is invoked, which
 * brings up a Load File dialog box, allowing the user to select a text file to
 * load into the component. The following table lists the available actions,
 * specifies the components the actions apply to, and describes what the actions
 * do.
 * </p>
 * 
 * <p>
 ...
 * <TD>any subclass of <code>javax.swing.JTextComponent</code> bound to a
 * <code>DBTextDataBinder</code></TD>
 ...
 * <TD><code>javax.swing.JEditorPane</code> or
 * <code>com.borland.dbswing.JdbEditorPane</code></TD>
 * <TD>loads an HTML page into a <code>JdbEditorPane</code> via URL</TD>
 * </TR>
 * 
 * <TR>
 * <TD>load-file (<code>DBTextDataBinder.LoadFileAction</code>)</TD>
 * <TD>any subclass of <code>javax.swing.JTextComponent</code> other than
 * <code>JTextField</code></TD>
 ...
 * <TD>any subclass of <code>javax.swing.JTextComponent</code> bound to a
 * <code>DBTextDataBinder</code></TD>
 * <TD>posts component data to its corresponding <code>DataSet</code>
 * <code>Column</code></TD>
 * </TR>
 * 
 * <TR>
 ...
 * <TD>any subclass of <code>javax.swing.JTextComponent</code> bound to a
 * <code>DBTextDataBinder</code></TD>
 * <TD>reverts component data to its corresponding <code>DataSet</code>
 * <code>Column</code> value</TD>
 * </TR>
 * 
 * <TR>
 * <TD>font-dialog (<code>DBTextDataBinder.FontDialogAction</code>)</TD>
 * <TD>any subclass of <code>javax.swing.JTextPane</code></TD>
 * <TD>displays dbSwing's <code>FontChooser</code> dialog to change the text's
 * font</TD>
 * </TR>
 * 
 * <TR>
 * <TD>foreground-color-dialog (
 * <code>DBTextDataBinder.ForegroundColorDialogAction</code>) *</TD>
 * <TD>any subclass of <code>javax.swing.JTextPane</code></TD>
 * <TD>displays Swing's <code>JColorChooser</code> dialog to change the text's
 * foreground color</TD>
 * </TR>
 * 
 * <TR>
 * <TD>background-color-dialog (
 * <code>DBTextDataBinder.BackgroundColorDialogAction</code>)</TD>
 * <TD>any subclass of <code>javax.swing.JTextPane</code></TD>
 * <TD>displays Swing's <code>JColorChooser</code> dialog to change the text's
 * background color</TD>
 * </TR>
...
public class DBTextDataBinder implements DocumentListener, FocusListener,
    MouseListener, KeyListener, AccessListener, DataChangeListener,
    NavigationListener, UndoableEditListener, PropertyChangeListener,
    HyperlinkListener,
    // ColumnChangeListener,
    ColumnAware, Designable, Serializable, HierarchyListener {
  
  /**
   * 
   */
  private static final long serialVersionUID = 9196756406526810436L;
  ...
  /**
   * <p>
   * A reference to an action that removes the data displayed in the component
  ...
  /**
   * <p>
   * A reference to an action that copies the data displayed in the component to
  ...
  /**
   * <p>
   * A reference to an action that pastes text from the system clipboard into
   * the component.
   * </p>
   */
  ...
  /**
   * <p>
   * A reference to an action that displays a font dialog box so the user can
   * select a font for the component.
   * </p>
   */
  ...
  /**
   * <p>
   * A reference to an action that displays a color dialog box so the user can
   * select a foreground color for the component.
   * </p>
   */
  ...
  /**
   * <p>
   * A reference to an action that displays a color dialog for changing the
  ...
  /**
   * <p>
   * Constructs a <code>DBTextDataBinder</code>. Calls the <code>null</code>
  ...
  /**
   * <p>
   * Constructs a <code>DBTextDataBinder</code> and specifies the
   * <code>JTextComponent</code> it makes data-aware. Calls the
   * <code>null</code> constructor of its superclass.
   * </p>
   * 
   * @param textComponent
   *          The component you are making data-aware with
   *          <code>DBTextDataBinder</code>.
   */
  ...
  static {
    ...
    UNDO_ACTION.putValue(Action.SMALL_ICON, new ImageIcon(UNDO_ACTION
        .getClass().getResource("image/undo.gif")));
    REDO_ACTION = new RedoAction();
    REDO_ACTION.putValue(Action.SMALL_ICON, new ImageIcon(REDO_ACTION
        .getClass().getResource("image/redo.gif")));
    CUT_ACTION = new DefaultEditorKit.CutAction();
    CUT_ACTION.putValue(Action.SMALL_ICON,
        new ImageIcon(DBTextDataBinder.class.getResource("image/cut.gif")));
    COPY_ACTION = new CopyAction(); // new DefaultEditorKit.CopyAction()
    COPY_ACTION.putValue(Action.SMALL_ICON, new ImageIcon(
        DBTextDataBinder.class.getResource("image/copy.gif")));
    PASTE_ACTION = new DefaultEditorKit.PasteAction();
    PASTE_ACTION.putValue(Action.SMALL_ICON, new ImageIcon(
        DBTextDataBinder.class.getResource("image/paste.gif")));
    CLEARALL_ACTION = new ClearAllAction();
    CLEARALL_ACTION.putValue(Action.SMALL_ICON, new ImageIcon(CLEARALL_ACTION
        .getClass().getResource("image/clearAll.gif")));
    SELECTALL_ACTION = new SelectAllAction();
    FONTDIALOG_ACTION = new FontDialogAction();
    FONTDIALOG_ACTION.putValue(Action.SMALL_ICON, new ImageIcon(
        FONTDIALOG_ACTION.getClass().getResource("image/font.gif")));
    FOREGROUNDCOLOR_ACTION = new ForegroundColorDialogAction();
    FOREGROUNDCOLOR_ACTION.putValue(Action.SMALL_ICON, new ImageIcon(
        FOREGROUNDCOLOR_ACTION.getClass().getResource("image/fgcolor.gif")));
    BACKGROUNDCOLOR_ACTION = new BackgroundColorDialogAction();
    BACKGROUNDCOLOR_ACTION.putValue(Action.SMALL_ICON, new ImageIcon(
        BACKGROUNDCOLOR_ACTION.getClass().getResource("image/bgcolor.gif")));
    LOADFILE_ACTION = new LoadFileAction();
    LOADFILE_ACTION.putValue(Action.SMALL_ICON, new ImageIcon(LOADFILE_ACTION
        .getClass().getResource("image/loadFile.gif")));
    LOADURL_ACTION = new LoadURLAction();
    LOADURL_ACTION.putValue(Action.SMALL_ICON, new ImageIcon(LOADURL_ACTION
        .getClass().getResource("image/loadURL.gif")));
    SAVEFILE_ACTION = new SaveFileAction();
    SAVEFILE_ACTION.putValue(Action.SMALL_ICON, new ImageIcon(SAVEFILE_ACTION
        .getClass().getResource("image/saveFile.gif")));
  }
  ...
  /**
   * <p>
   * Sets the text component that <code>DBTextDataBinder</code> makes
   * data-aware. The component must be one that extends
   * <code>JTextComponent</code>, such as <code>JTextField</code>,
   * <code>JTextArea</code>, <code>JTextPane</code>, or <code>JEditorPane</code>
   * .
   * </p>
   * 
   * @param textComponent
   *          The text component that <code>DBTextDataBinder</code> makes
   *          data-aware.
  ...
  public void setJTextComponent(JTextComponent textComponent) {
    ...
    if (textComponent == null) {
      ...
      textComponent.addHierarchyListener(this);
      // add our keymap to the component
      setKeyMap((textComponent instanceof JTextField) ? fieldKeyBindings
          : areaKeyBindings);
      setDocument(textComponent.getDocument());
      if (textComponent instanceof JEditorPane
          && !(textComponent instanceof JTextPane)) {
  ...
  void setKeyMap(JTextComponent.KeyBinding[] keymap) {
    JTextComponent.removeKeymap(keymapName);
    Keymap originalKeymap = textComponent.getKeymap();
    Keymap textDataBinderKeymap = JTextComponent.addKeymap(keymapName,
        originalKeymap);
    JTextComponent.loadKeymap(textDataBinderKeymap, keymap, TextAction
        .augmentList(textComponent.getActions(), textDataBinderActions));
    textComponent.setKeymap(textDataBinderKeymap);
  }
  
  /**
   * <p>
   * Retursn the text component that <code>DBTextDataBinder</code> makes
   * data-aware. The component extends <code>JTextComponent</code>.
   * </p>
   * 
   * @return The text component that <code>DBTextDataBinder</code> makes
   *         data-aware.
  ...
  /**
   * <p>
   * Sets the the text component's model. Any component using a
   * <code>Document</code> class as its model can be made data-aware. Note that
   * when using this approach you are responsible for opening the
   * <code>DataSet</code> before using it.
   * </p>
   * 
   * @param document
  ...
  // used to bind/unbind the data binder from the document to support
  // serialization.
  ...
  /**
   * <p>
   * Sets whether a popup menu is enabled on the component. If
   * <code>enablePopupMenu</code> is <code>true</code>, a menu pops up when the
   * user right-clicks on the component or presses <KBD>Shift+F10</KBD>. This is
  ...
  public void setTrim(boolean trim) {
    columnAwareSupport.setTrim(trim);
  }
  
  public boolean isTrim() {
    return columnAwareSupport.isTrim();
  }
  
  /**
   * <p>
   * Sets whether the current text is entered in the <code>DataSet's</code>
   * column when focus is lost on the text area. The default value is
   * <code>true</code>.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns whether the current text is entered in the <code>DataSet's</code>
   * column when focus is lost on the text area.
   * </p>
   * 
  ...
  /**
   * <p>
   * Sets whether the current text should be put in the <code>DataSet's</code>
   * column when the current row is posted. This occurs, for example, if the
   * user presses a row navigation key while the text component has current
   * focus. The default value is <code>true</code>.
   * </p>
   * 
   * @param postOnRowPosted
   *          If <code>true</code>, the current text should be put in the
   *          <code>DataSet's</code> column.
  ...
  /**
   * <p>
   * Returns whether the current text should be put in the
   * <code>DataSet's</code> column when the current row is posted.
   * </p>
   * 
   * @return If <code>true</code>, the current text should be put in the
   *         <code>DataSet's</code> column.
  ...
  // write current field data to dataset column. does nothing if there's not a
  // valid dataset and column
  // if an error occurs on post, tries to set focus back to the current field
  
  /**
   * <p>
   * Writes the current field data to the <code>DataSet</code> column if the
   * <code>dataSet</code> and <code>columnName</code> properties are valid. The
   * <code>postText()</code> method displays an error dialog if the data is
   * invalid.
   * </p>
   */
  public void postText() {
    try {
      ...
      DBExceptionHandler.handleException(columnAwareSupport.dataSet,
          textComponent, e);
      if (textComponent != null) {
  ...
  public void postText2() throws Exception {
    if (isTextModified() && columnAwareSupport.isValidDataSetState()) {
      ...
      if (columnAwareSupport.getColumn().getDataType() == Variant.OBJECT) {
        bindDocument(document, false); // to allow DataStore to serialize the
        // document
        ...
        ObjectInputStream ois = new ObjectInputStream(new ByteArrayInputStream(
            b));
        columnAwareSupport.setObject(ois.readObject());
        baos = null;
        ...
        if (ems != null) {
          ...
          try {
            ...
            document.insertString(0, columnAwareSupport.getFormattedString(),
                null);
            displayMode = true;
          } catch (Exception e) {
            if (e instanceof InvalidFormatException) {
              state.cursorPos = ((InvalidFormatException) e).getErrorOffset(); // error
              // adjusts
              // cursor
            }
            ...
            ValidationException.invalidFormat(e,
                columnAwareSupport.getColumn(), null);
          }
        } else {
          // SS
          // StringWriter t = new StringWriter();
          // textComponent.write(t);
          // text = t.toString();
          
          text = document.getText(0, document.getLength());
          columnAwareSupport.setFromString2(text, textComponent,
              columnAwareSupport);
          if (document.getLength() > 0)
            document.remove(0, document.getLength());
  ...
  public void updateText() {
    ...
    try {
      if (columnAwareSupport.isValidDataSetState()) {
        if (columnAwareSupport.getColumn().getDataType() == Variant.OBJECT) {
          if (textComponent != null) {
            if (columnNameURL != null
                && columnAwareSupport.dataSet.hasColumn(columnNameURL) != null
                && !columnAwareSupport.dataSet.isNull(columnNameURL)
                && columnAwareSupport.dataSet
                    .isNull(columnAwareSupport.columnName)) {
              ((JEditorPane) textComponent).setPage(columnAwareSupport.dataSet
                  .getString(columnNameURL));
            } else {
              Object object = columnAwareSupport.dataSet
                  .getObject(columnAwareSupport.columnName);
              if (object instanceof Document) { // Variant seems to return a
                // ByteArrayInputStream for null
                // values
                try {
                  ByteArrayOutputStream baos;
                  ObjectOutputStream oos = new ObjectOutputStream(
                      baos = new ByteArrayOutputStream(50000));
                  oos.writeObject(columnAwareSupport.dataSet
                      .getObject(columnAwareSupport.columnName));
                  oos.flush();
                  oos.close();
                  byte[] b = baos.toByteArray();
                  ...
                  DBExceptionHandler.handleException(
                      columnAwareSupport.dataSet, textComponent, e);
                }
              } else {
                if (!ignoreModelChange) {
                  textComponent.setDocument(textComponent.getUI()
                      .getEditorKit(textComponent).createDefaultDocument());
                }
              }
            }
          }
          ...
          // SS
          // Reader r = new StringReader(expandDateYear(columnAwareSupport));
        ...
        if (textComponent != null) {
          if (textComponent.hasFocus())
            ...
            if (textComponent instanceof JTextField)
              ((JTextField) textComponent).setScrollOffset(0); // Zum Anfang
                                                               // scrollen
          }
          // if (ems != null) {
          // ems.move(state, KeyEvent.VK_END);
  ...
  /**
   * <p>
   * The <code>expandDateYear()</code> method returns a dataset column value
   * with the year always expanded to a 4 digit year (the default is to show
   * only 2 digits), unless an edit mask has been explicitly set on the column.
   * </p>
   * 
  ...
  private static javax.swing.filechooser.FileFilter SerFileFilter = new javax.swing.filechooser.FileFilter() {
    ...
    public boolean accept(File file) {
      ...
      String fileName = file.getName().toLowerCase();
      if (fileName.toUpperCase().endsWith("SER")) {
        return true;
      }
      return false;
    }
  ...
  private static JFileChooser createFileChooser(
    ...
    // to remove the 'all files' filter, I had to call setFileFilter and then
    // remove the
  ...
  public void setDataSet(DataSet dataSet) {
    ...
    if (dataSet != null) {
      ...
      if (focusedUndoManager == undoManager)
        focusedUndoManager = null;
      if (focusedDataBinder == this)
        focusedDataBinder = null;
    }
  }
  
  /**
   * <p>
   * Returns the <code>DataSet</code> from which values are read and to which
   * values are written.
   * </p>
   * 
  ...
  /**
   * <p>
   * Sets the column name of the <code>DataSet</code> to/from which values
   * should be written/read. For a <code>JdbTextField</code>, the column can be
   * of any type. For a <code>JdbTextArea</code>, the column would typically be
   * of type <code>String.</code> For <code>JdbTextPane</code> and
   * <code>JdbEditorPane</code> components, the column can be of type
   * <code>String</code>, but must be of type <code>Object</code> to hold styled
   * text, RTF, or HTML documents.
   * </p>
   * 
   * @param columnName
  ...
  /**
   * <p>
   * Returns the column name of the <code>DataSet</code> to/from which values
  ...
  /**
   * <p>
   * Sets the column name in which URL names (e.g., "http://www.borland.com")
   * are cached and searched. The column should be of type <code>String</code>,
   * and will only be used if a <code>JdbEditorPane</code> is bound to this data
   * binder. Setting a value in this column will cause the corresponding page to
   * be loaded by a <code>JdbEditorPane</code> and saved in
  ...
  /**
   * <p>
   * Returns the column name in which URL names (e.g., "http://www.borland.com")
   * are cached and searched.
   * </p>
   * 
  ...
  /**
   * <p>
   * Creates the popup menu displayed when the user right-clicks or presses
   * <KBD>Shift+F10</KBD> within the bound text component.
   * </p>
   * 
   * <p>
   * The contents of the menu vary according to the kind of text component and
   * property settings as shown in the following table. Menu items are displayed
   * in the vertical order in which they are listed below.
   * </p>
   * 
   * <p>
   ...
   * <TD><code>JdbTextPane</code>, <code>enableFontChange</code> =
   * <code>true</code></TD>
   * </TR>
   * 
   * <TR>
   ...
   * <TD><code>JdbTextPane</code>, <code>enableColorChange</code> =
   * <code>true</code></TD>
   * </TR>
   * 
   * <TR>
   ...
   * <TD><code>JdbEditorPane</code>, <code>enableURLLoading</code> =
   * <code>true</code></TD>
   * </TR>
   * 
   * <TR>
   ...
   * <TD><code>JdbTextArea</code> (text files only), <code>JdbTextPane</code>
   * (text or ser file), <code>JdbEditorPane</code> (text, RTF, HTML, ser
   * files), <code>enableFileLoading</code> = <code>true</code></TD>
   * </TR>
   * 
   * <TR>
   * <TD>Save File...</TD>
   ...
   * <TD><code>JdbTextArea</code> (text files only), <code>JdbTextPane</code>
   * (text or ser file), <code>JdbEditorPane</code> (text, RTF, HTML, ser
   * files), <code>enableFileSaving</code> = <code>true</code></TD>
   * </TR>
   * 
   * <TR>
   * <TD>Undo</TD>
   ...
   * 
   * <p>
   * Setting the <code>enablePopupMenu</code> property to <code>false</code>
   * prevents the entire menu from appearing. To add your own menu items to the
   * menu, override this method in a subclass to return a customized menu.
   * </p>
   * 
   * @return The menu.
   */
  protected JPopupMenu createPopupMenu() {
    ...
    if ((enableFontChange || enableColorChange)
        && textComponent.isEditable()
        && textComponent instanceof JEditorPane
        && (((JEditorPane) textComponent).getEditorKit() instanceof StyledEditorKit || ((JEditorPane) textComponent)
            .getEditorKit() instanceof RTFEditorKit)) {
      if (columnAwareSupport.dataSet == null
          || columnAwareSupport.columnName == null
          || (columnAwareSupport.columnOrdinal != -1 && columnAwareSupport
              .getColumn().getDataType() == Variant.OBJECT)) {
  ...
  /**
   * <p>
   * Sets whether the Clear All menu selection is added to the default popup
   * menu. <code>True</code> by default.
   * </p>
   * 
   * @param enableClearAll
   *          If <code>true</code>, Clear All is added to the default popup
   *          menu.
  ...
  /**
   * <p>
   * Returns whether the Clear All menu selection has been added to the default
   * popup menu.
   * 
  ...
  /**
   * <p>
   * Sets whether the foreground and background color menu selections are added
   * to the default popup menu. <code>True</code> by default.
   * </p>
   * 
   * @param enableColorChange
   *          If <code>true</code>, the foreground and background color menu
   *          selections are added to the default popup menu.
  ...
  /**
   * <p>
   * Returns whether the foreground and background color menu selections are
   * added to the default popup menu.
   * 
   * @return If <code>true</code>, the foreground and background color menu
   *         selections are added to the default popup menu.
  ...
  /**
   * <p>
   * Returns whether the font setting menu command is displayed on the popup
   * menu.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Sets whether the Undo and Redo popu menu commands are displayed on the
   * popup menu. The default value is <code>true</code>.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns whether the Undo and Redo popu menu commands are displayed on the
   * popup menu.
   * </p>
   * 
  ...
  /**
   * <p>
   * Sets whether HTML pages fetched using hyperlinks are automatically inserted
   * as new rows if they don't already exist in the <code>DataSet</code> (for
   * example, if the URL in the <code>columnNameURL</code> column can't be
   * found).
   * </p>
   * 
   * <p>
   * This property is ignored unless the data binder is bound to a
   * <code>JdbEditorPane</code>, the <code>columnNameURL</code> property is set,
   * and the associated <code>DataSet</code> allows new rows to be inserted. The
   * default value is <code>true</code>.
   * </p>
   * 
   * @param enableURLCache
   *          If <code>true</code>, HTML pages are automatically inserted as new
   *          rows.
   * @see #isEnableURLAutoCache
   */
  ...
  /**
   * <p>
   * Returns whether HTML pages fetched using hyperlinks are automatically
   * inserted as new rows if they don't already exist in the
   * <code>DataSet</code> (for example, if the URL in the
   * <code>columnNameURL</code> column can't be found).
   * </p>
   * 
   * @return If <code>true</code>, HTML pages are automatically inserted as new
   *         rows.
   * @see #setEnableURLAutoCache
   */
  ...
  /**
   * <p>
   * Determines if pressing <kbd>Enter</kbd> in a <code>JTextField</code>
   * automatically moves focus to the next focusable field. This is
   * <code>true</code> by default.
   * </p>
   * 
   * @param nextFocusOnEnter
   *          If <code>true</code>, pressing <kbd>Enter</kbd> will move focus to
  ...
  /**
   * <p>
   * Returns <code>true</code>if pressing <kbd>Enter</kbd> in a
   * <code>JTextField</code> automaticallys moves focus to the next focusable
   * field.
   * </p>
   * 
   * @return If <code>true</code>, pressing <kbd>Enter</kbd> will move focus to
   *         next focusable field.
  ...
  /**
   * <p>
   * Sets whether the Load Text menu command is displayed on the popup menu.
  ...
  /**
   * <p>
   * Sets whether the Save Text menu command is displayed on the popup menu.
   * This is <code>true</code> by default.
   * </p>
   * 
  ...
  /**
   * Returns whether or not the text has been modified. It is set to
   * <code>true</code> on any change to the document model. It is set to
   * <code>false</code> after the value has been saved to a <code>DataSet</code>
   * or file.
   * 
  ...
  /**
   * Sets whether or not the text has been modified. Set to <code>true</code> on
   * any change to the document model. Set to <code>false</code> after the value
   * has been saved to a <code>DataSet</code> or file.
   * 
   * @param textModified
   ...
   * public void changed(DataSet dataSet, Column column, Variant value) { if
   * (!ignoreURLChange) { if (textComponent instanceof JEditorPane &&
   * !(textComponent instanceof JTextPane)) { try { ((JEditorPane)
   * textComponent).setPage(value.getString()); } catch (Exception ex) {
   * DBExceptionHandler.handleException(dataSet, textComponent, ex); } } }
  ...
  private void textModified(DocumentEvent e) {
    if (!ignoreValueChange && !isTextModified()
        && columnAwareSupport.isValidDataSetState()) {
      ignoreValueChange = true;
      final boolean wasEditing = columnAwareSupport.dataSet.isEditing();
      boolean okUpdate = true;
      try {
        // touch the field so we're guaranteed to get a postRow notification
        // later
        ...
        SwingUtilities.invokeLater(new Runnable() {
          ...
          public void run() {
            if (!wasEditing)
              columnAwareSupport.dataSet.cancel();
            updateText();
            DBExceptionHandler.handleException(columnAwareSupport.dataSet,
                textComponent, ex);
          }
  ...
  public void focusGained(FocusEvent e) {
    ...
    FONTDIALOG_ACTION.setEnabled(((FontDialogAction) FONTDIALOG_ACTION)
        .isActionAvailable(textComponent));
    FOREGROUNDCOLOR_ACTION
        .setEnabled(((ForegroundColorDialogAction) FOREGROUNDCOLOR_ACTION)
            .isActionAvailable(textComponent));
    BACKGROUNDCOLOR_ACTION
        .setEnabled(((BackgroundColorDialogAction) BACKGROUNDCOLOR_ACTION)
            .isActionAvailable(textComponent));
    LOADURL_ACTION.setEnabled(((LoadURLAction) LOADURL_ACTION)
        .isActionAvailable(textComponent));
    LOADFILE_ACTION.setEnabled(((LoadFileAction) LOADFILE_ACTION)
        .isActionAvailable(textComponent));
    SAVEFILE_ACTION.setEnabled(((SaveFileAction) SAVEFILE_ACTION)
        .isActionAvailable(textComponent));
    ...
    // (SS) Wenn diese Komponente auf einem JTable ist, dann darf nicht
    // postOnFocusLost true sein, da sonst bei ESC trotzdem gespeichert wird
    if (isOnTable()) {
      postOnFocusLost = false;
      nextFocusOnEnter = false;
    }
  }
  ...
  public void mouseClicked(MouseEvent e) {
    if (ems != null && textComponent != null) {
      ...
      // System.out.println("DBTextDataBinder.mouseClicked() propose cursor at "
      // + state.cursorPos);
      // ems.move(state, MouseEvent.MOUSE_CLICKED);
      // System.out.println("DBTextDataBinder.mouseClicked() final cursor at " +
      // state.cursorPos);
      // if (displayMode) {
      // updateDisplay();
      // displayMode = false;
  ...
  private void updateSelection() {
    // if (state != null) {
    // Diagnostic.trace(Trace.MaskableEditor, "updateSelection(" +
    // state.cursorPos + ")");
    // Diagnostic.trace(Trace.MaskableEditor, " buffer is " +
    // state.displayString.length() + " and text is " + getText().length());
    // if (allSelected) {
    // textComponent.setCaretPosition(0);
  ...
  public void keyReleased(KeyEvent e) {
    ...
    // try {
    // Rectangle rect =
    // textComponent.modelToView(textComponent.getCaretPosition());
    // point.x = rect.x;
    // point.y = rect.y;
    // displayPopup(point);
    // }
  ...
  public void dataChanged(DataChangeEvent event) {
    if (!dataSetEventsEnabled || event == null || columnAwareSupport == null
        || columnAwareSupport.dataSet == null) {
      return;
    }
    // depending upon the event, we might have to update the current
    // field value.
    int affectedRow = event.getRowAffected();
    boolean affectedOurRow = ((affectedRow == columnAwareSupport.dataSet
        .getRow()) && event.isColumnAffected(columnAwareSupport.columnName))
        || affectedRow == -1;
  ...
  protected void bindColumnProperties() {
    ...
    if (textComponent != null && textComponent.isDisplayable()) {
      ...
      columnAwareSupport.columnChanged = true;
      ...
      if (columnAwareSupport.isValidDataSetState()) {
        ...
        Column column = columnAwareSupport.getColumn();
        if (textComponent instanceof JTextField
            && ((JTextField) textComponent).getHorizontalAlignment() == (DBUtilities
                .is1pt3() ? SwingConstants.LEADING : SwingConstants.LEFT)) {
          ((JTextField) textComponent).setHorizontalAlignment(DBUtilities
              .convertJBCLToSwingAlignment(column.getAlignment(), true));
        }
        ...
        if (column.getDataType() == Variant.STRING
          ...
          if (!(textComponent.getDocument() instanceof DBPlainDocument)) {
            try {
              String content = textComponent.getDocument().getText(0,
          ...
          DBPlainDocument document = (DBPlainDocument) textComponent
              .getDocument();
          if (column.getPrecision() > 0
              && document.getMaxLength() != column.getPrecision()) {
            document.setMaxLength(column.getPrecision());
          }
          
          if (column.getEditMask() != null
        ...
        // SS: Editable-Status mit Column-Status synchronisieren
        textComponent.setEditable(getDataSet().isEditable()
            && column.isEditable() && !column.isReadOnly());
        
        // SS: Spinner/Zahlenfelder müssen Formatierung beachten:
        int scale = column.getScale();
        if (scale == -1)
          scale = 2;
        if (scale >= 0 && textComponent instanceof JFormattedTextField) {
          JFormattedTextField tf = (JFormattedTextField) textComponent;
  ...
  public void undoableEditHappened(UndoableEditEvent e) {
    if (document instanceof HTMLDocument
        && (textComponent != null && !textComponent.isEditable())) {
      return;
    }
  ...
  public static class UndoAction extends DBTextAction {
    public UndoAction() {
      ...
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/undo.gif")));
      setEnabled(false);
    }
      ...
      if (dataBinder != null) {
        try {
          if (DBTextDataBinder.focusedUndoManager.canUndo()) {
            ...
            DBTextDataBinder.UNDO_ACTION
                .setEnabled(DBTextDataBinder.focusedUndoManager.canUndo());
            DBTextDataBinder.REDO_ACTION
                .setEnabled(DBTextDataBinder.focusedUndoManager.canRedo());
          }
  ...
  public static class RedoAction extends DBTextAction {
    public RedoAction() {
      super(redoAction);
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/redo.gif")));
      setEnabled(false);
    }
  ...
  public void hyperlinkUpdate(HyperlinkEvent e) {
    ...
    if (e.getEventType() == HyperlinkEvent.EventType.ENTERED) {
      ((JEditorPane) textComponent).setCursor(Cursor
      ...
      if (e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
        ...
        try {
          if (columnNameURL != null && e.getDescription().charAt(0) != '#') {
            if (locateRow == null
                || (locateRow.hasColumn(columnNameURL) == null)) {
            ...
            if (!columnAwareSupport.dataSet.locate(locateRow, Locate.FIRST)) {
              ...
              columnAwareSupport.dataSet.setString(columnNameURL, e.getURL()
                  .toString());
              ignoreURLChange = false;
            } else {
              if (columnAwareSupport.dataSet
                  .isNull(columnAwareSupport.columnName)) {
                ((JEditorPane) textComponent).setPage(e.getURL());
              }
            }
  ...
  /**
   * <p>
   * The name of the action that displays a font dialog box so the user can
   * select a font for the component.
   * </p>
   */
  ...
  /**
   * <p>
   * The name of the action that displays a color dialog box so the user can
   * select a foreground color for the component.
   * </p>
   */
  ...
  /**
   * <p>
   * The name of the action that navigates to the next row in the
   * <code>DataSet</code> the component is bound to.
   * </p>
   */
  ...
  /**
   * <p>
   * The name of the action that navigates to the previous row in the
   * <code>DataSet</code> the component is bound to.
   * </p>
   */
  ...
  /**
   * <p>
   * The name of the action that posts text to the <code>DataSet</code>. forward
   * movement
   * </p>
   */
   ...
   * </p>
   */
  public static final String postDataBackAction = "post-data-back";
  
  /**
   * <p>
   * The name of the action that cancels a posting of the text to the
   * <code>DataSet</code>.
   * </p>
   */
  ...
  private transient final JTextComponent.KeyBinding[] fieldKeyBindings = {
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(
          KeyEvent.VK_PAGE_DOWN, 0, false), nextRowAction),
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_PAGE_UP,
          0, false), priorRowAction),
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER,
          0, false), postDataAction),
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER,
          Event.SHIFT_MASK, false), postDataBackAction),
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE,
          0, false), cancelPostAction),
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_INSERT,
          Event.CTRL_MASK, false), insertRowAction),
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_DELETE,
          Event.CTRL_MASK, false), deleteRowAction), };
  
  private transient final JTextComponent.KeyBinding[] areaKeyBindings = {
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(
          KeyEvent.VK_PAGE_DOWN, Event.CTRL_MASK, false), nextRowAction),
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_PAGE_UP,
          Event.CTRL_MASK, false), priorRowAction),
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER,
          Event.CTRL_MASK, false), postDataAction),
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER,
          Event.CTRL_MASK | Event.SHIFT_MASK, false), postDataBackAction),
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE,
          0, false), cancelPostAction),
      new JTextComponent.KeyBinding(KeyStroke.getKeyStroke(KeyEvent.VK_INSERT,
          Event.CTRL_MASK, false), insertRowAction),
  ...
  private final Action[] textDataBinderActions = { new NextRowAction(),
      new PriorRowAction(), new PostDataAction(true),
      new PostDataAction(false), new CancelPostAction(), new InsertRowAction(),
      new DeleteRowAction(), };
  
  private static JTextComponent getTextComponentExt(ActionEvent e) {
    ...
    o = KeyboardFocusManager.getCurrentKeyboardFocusManager().getFocusOwner();
    if (o instanceof JTextComponent)
      return (JTextComponent) o;
  ...
  public static class CopyAction extends TextAction {
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
      JTextComponent target = getTextComponentExt(e);
      if (target != null) {
  ...
  public static class LoadURLAction extends DBTextAction {
    public LoadURLAction() {
      super(loadURLAction);
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/loadURL.gif")));
      setEnabled(false);
    }
    
    @Override
    public void actionPerformed(ActionEvent e) {
      // has the side effect of setting target in DBTextAction to the
      // JTextComponent
      DBTextDataBinder dataBinder = getDBTextDataBinder(e);
      ...
      if (isActionAvailable(target)) {
        ...
        StringBuffer widePrompt = new StringBuffer(java.lang.Math.max(60,
            promptString.length()));
        widePrompt.append(promptString);
        for (int i = widePrompt.length(); i < widePrompt.capacity(); i++) {
          widePrompt.append(' ');
        }
        String url = JOptionPane.showInputDialog(target, widePrompt.toString(),
            Res._URLDialogTitle, JOptionPane.QUESTION_MESSAGE);
        if (url == null) {
          return;
        }
        try {
          ...
          if (dataBinder != null
              && dataBinder.columnAwareSupport.dataSet != null) {
            if (dataBinder.columnNameURL != null
                && dataBinder.columnAwareSupport.dataSet
                    .hasColumn(dataBinder.columnNameURL) != null) {
              // avoid auto page reload when URL changes
              DBTextDataBinder.ignoreURLChange = true;
              dataBinder.columnAwareSupport.dataSet.setString(
                  dataBinder.columnNameURL, url);
              DBTextDataBinder.ignoreURLChange = false;
            }
          }
        } catch (Exception ex) {
          DBExceptionHandler.handleException(null, target, ex);
    ...
    public boolean isActionAvailable(JTextComponent target) {
      return target != null && target instanceof JEditorPane
          && !(target instanceof JTextPane);
    }
  }
  ...
  public static class LoadFileAction extends TextAction {
    public LoadFileAction() {
      ...
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/loadFile.gif")));
      setEnabled(false);
    }
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (isActionAvailable(target)) {
        ...
        if (target instanceof JTextArea) {
          ...
          fileChooser = createFileChooser(new javax.swing.filechooser.FileFilter[] {
              TextFileFilter, SerFileFilter });
          fileChooser.setDialogTitle(Res._OpenTextorSerTitle);
        } else if (target instanceof JEditorPane) {
          fileChooser = createFileChooser(new javax.swing.filechooser.FileFilter[] {
              TextFileFilter, HTMLFileFilter, RTFFileFilter, SerFileFilter });
          ...
          if (file != null && file.exists()) {
            if (target instanceof JTextArea || target instanceof JTextPane) {
              if (target instanceof JTextPane
                  && file.getName().toUpperCase().endsWith("SER")) {
                try {
                  ...
                  if (object instanceof StyledDocument) {
                    ((JTextPane) target)
                        .setStyledDocument((StyledDocument) object);
                  } else {
                    JOptionPane.showMessageDialog(target, Res._InvalidSerFile,
                ...
                try {
                  ...
                  try {
                    String content = temp.getDocument().getText(0,
                        temp.getDocument().getLength());
                    Document document = target.getDocument();
                    if (document.getLength() > 0)
                      document.remove(0, document.getLength());
              ...
              if (file.getName().toUpperCase().endsWith("SER")) {
                ...
                try {
                  ...
                  // many thanks to Kim Topley, author of
                  // "CORE Java Foundation Classes" for
                  ...
                  Document document = ((JEditorPane) target).getEditorKit()
                      .createDefaultDocument();
                  ignoreModelChange = true;
                  target.setDocument(document);
                  ignoreModelChange = false;
                  if (type.equals("text/rtf")) {
                    ((JEditorPane) target).getEditorKit().read(inputStream,
                        document, 0);
                  } else {
                    try {
                      Reader inputStreamReader = new BufferedReader(
                          new InputStreamReader(inputStream));
                      document.putProperty("IgnoreCharsetDirective",
                          new Boolean(true));
                      ((JEditorPane) target).getEditorKit().read(
                          inputStreamReader, document, 0);
                      // ((JEditorPane) target).read(inputStreamReader,
                      // document);
            ...
            JOptionPane.showMessageDialog(target, Res._FileNotExist, "",
                JOptionPane.ERROR_MESSAGE);
          }
        }
        target.repaint();
    ...
    public boolean isActionAvailable(JTextComponent target) {
      return target != null && target.isEditable()
          && (target instanceof JTextArea) || (target instanceof JEditorPane);
    }
  }
  ...
  public static class SaveFileAction extends TextAction {
    public SaveFileAction() {
      ...
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/saveFile.gif")));
      setEnabled(false);
    }
      ...
      if (isActionAvailable(target)) {
        ...
        if (target instanceof JTextArea) {
          ...
          if (contentType.equals("text/rtf")) {
            fileChooser = createFileChooser(new javax.swing.filechooser.FileFilter[] {
                TextFileFilter, RTFFileFilter, SerFileFilter });
            fileChooser.setDialogTitle(Res._SaveTextorRTForSerTitle);
          } else if (contentType.equals("text/html")) {
            fileChooser = createFileChooser(new javax.swing.filechooser.FileFilter[] {
                TextFileFilter, HTMLFileFilter, SerFileFilter });
          ...
          if (file != null) {
            if (file.exists()) {
              int response = JOptionPane.showConfirmDialog(target,
                  Res._OverwriteFile, "", JOptionPane.OK_CANCEL_OPTION);
            ...
            if (file.getName().toUpperCase().endsWith("SER")) {
              try {
                ...
                // have to temporarily detach ourself as a Document listener,
                // since JTextComponent serializes
                ...
                if (DBTextDataBinder.focusedDataBinder != null
                  ...
                  DBTextDataBinder.focusedDataBinder.bindDocument(
                      target.getDocument(), false);
                }
                objectOutputStream.writeObject(target.getDocument());
                if (DBTextDataBinder.focusedDataBinder != null
                    && DBTextDataBinder.focusedDataBinder.getJTextComponent() == target) {
                  DBTextDataBinder.focusedDataBinder.bindDocument(
                      target.getDocument(), true);
                }
              ...
              if (contentType.equals("text/rtf")
                  && !file.getName().toUpperCase().endsWith("TXT")) {
                // have to use an OutputStream for 8-bit RTF, which should only
                // be loadable into a JEditorPane
                try {
                  OutputStream outputStream = new FileOutputStream(file);
                  ((JEditorPane) target).getEditorKit()
                      .write(outputStream, target.getDocument(), 0,
                          target.getDocument().getLength());
                  outputStream.flush();
                  outputStream.close();
                } catch (Exception ex) {
                  // IOException or FileNotFoundException
              ...
              } else { // either text/plain or text/html, or text/rtf forced to
                // plain text. Either way, we should use a Writer
                try {
                  Writer writer = new FileWriter(file);
                  if (file.getName().toUpperCase().endsWith("TXT")) {
                    writer.write(target.getDocument().getText(0,
                        target.getDocument().getLength()));
                  } else {
                    target.write(writer);
                  }
    ...
    public boolean isActionAvailable(JTextComponent target) {
      return target != null && (target instanceof JTextArea)
          || (target instanceof JEditorPane);
    }
  }
  ...
  public static class NextRowAction extends DBTextAction {
    public NextRowAction() {
      super(nextRowAction);
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/next.gif")));
    }
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (dataBinder != null && dataBinder.columnAwareSupport.dataSet != null) {
        try {
          ...
          DBExceptionHandler.handleException(
              dataBinder.columnAwareSupport.dataSet, target, ex);
        }
      }
    }
  }
  ...
  public static class PriorRowAction extends DBTextAction {
    public PriorRowAction() {
      ...
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/prior.gif")));
    }
  ...
  public static class PostDataAction extends DBTextAction {
    ...
    public PostDataAction(boolean forward) {
      super(forward ? postDataAction : postDataBackAction);
      this.forward = forward;
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/post.gif")));
    }
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (dataBinder != null) {
        try {
          ...
          if (e.getID() == POST_ONLY)
            return;
          KeyboardFocusManager kb = KeyboardFocusManager
              .getCurrentKeyboardFocusManager();
          if (dataBinder.isNextFocusOnEnter() && target instanceof JTextField) {
            if (forward)
              kb.focusNextComponent(target);
            else
              kb.focusPreviousComponent(target);
          } else if (dataBinder.isOnTable()) {
            JTable table = dataBinder.getTable();
            table.removeEditor();
            
            /*
             * long when = new GregorianCalendar().getTimeInMillis();
             * 
             * kb.dispatchEvent(new KeyEvent(table, KeyEvent.KEY_PRESSED, when,
             * 0, KeyEvent.VK_ENTER, '\n')); kb.dispatchEvent(new
             * KeyEvent(table, KeyEvent.KEY_TYPED, when, 0,
             * KeyEvent.VK_UNDEFINED, '\n')); kb.dispatchEvent(new
             * KeyEvent(table, KeyEvent.KEY_RELEASED, when, 0,
             * KeyEvent.VK_ENTER, '\n'));
             */
          }
          ...
          // DBExceptionHandler.handleException(
          // dataBinder.columnAwareSupport.dataSet, target, ex);
          throw new DataSetException(0, ex.getMessage(), ex);
        }
      }
    }
  ...
  public static class CancelPostAction extends DBTextAction {
    public CancelPostAction() {
      ...
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/cancel.gif")));
    }
  ...
  public static class InsertRowAction extends DBTextAction {
    public InsertRowAction() {
      ...
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/insert.gif")));
    }
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      DataSet dataSet;
      if (dataBinder != null
          && (dataSet = dataBinder.columnAwareSupport.dataSet) != null
          && dataSet.isEditable() && dataSet.isEnableInsert()
  ...
  public static class FontDialogAction extends TextAction {
    ...
    public FontDialogAction() {
      ...
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/font.gif")));
      setEnabled(false);
    }
          ...
          if (selStart != selEnd) {
            ...
            if (target instanceof JEditorPane) {
              ...
              if (editorKit instanceof StyledEditorKit) {
                MutableAttributeSet inputAttributes = ((StyledEditorKit) editorKit)
                    .getInputAttributes();
    ...
    public boolean isActionAvailable(JTextComponent target) {
      return target != null && target.isEditable()
          && target.getDocument() instanceof StyledDocument;
    }
  }
  ...
  public static class ForegroundColorDialogAction extends TextAction {
    public ForegroundColorDialogAction() {
      ...
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/fgcolor.gif")));
      setEnabled(false);
    }
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (isActionAvailable(target)) {
        ...
        if ((selectedColor = JColorChooser.showDialog(target, Res._SelectColor,
            null)) != null) {
          MutableAttributeSet attr = new SimpleAttributeSet();
  ...
  public static class BackgroundColorDialogAction extends TextAction {
    public BackgroundColorDialogAction() {
      ...
      putValue(Action.SMALL_ICON,
          new ImageIcon(getClass().getResource("image/bgcolor.gif")));
      setEnabled(false);
    }
  ...
  abstract static class DBTextAction extends TextAction {
    ...
    protected final DBTextDataBinder getDBTextDataBinder(ActionEvent e) {
      ...
      if (target != null) {
        ...
        } else if (target instanceof JdbEditorPane) {
          return ((JdbEditorPane) target).getDataBinder();
        }
      }
  ...
  // ColumnPaintListener support class. Need not be deployed
  // if ColumnPaintListener is not used.
  static class DBCustomPaintSite implements CustomPaintSite {
    ...
    void initDefaults(JTextComponent textComponent) {
      ...
      if (textComponent instanceof JTextField) {
        hAlignment = defaultAlignment = ((JTextField) textComponent)
    ...
    void fireEditing(JTextComponent textComponent, DBTextDataBinder binder,
        ColumnPaintListener columnPaintListener) {
      reset();
      columnPaintListener.editing(binder.columnAwareSupport.dataSet,
          binder.columnAwareSupport.getColumn(), this);
      updateComponent();
    }
    
    void firePainting(JTextComponent textComponent, DBTextDataBinder binder,
        ColumnPaintListener columnPaintListener) {
      reset();
      ...
      columnPaintListener.painting(binder.columnAwareSupport.dataSet,
          ...
          binder.columnAwareSupport.dataSet.getRow(), variantValue, this);
      if (variantCopy != null && !variantCopy.equals(variantValue)) {
        binder.ignoreValueChange = true;
        try {
          textComponent.setText(binder.columnAwareSupport.getColumn().format(
              variantValue));
        } catch (Exception e) {
          DBExceptionHandler.handleException(binder.columnAwareSupport.dataSet,
              textComponent, e);
        }
  ...
  public static final int POST_ONLY = 555;
  ...
  public void hierarchyChanged(HierarchyEvent e) {
    if (e.getComponent() == textComponent
