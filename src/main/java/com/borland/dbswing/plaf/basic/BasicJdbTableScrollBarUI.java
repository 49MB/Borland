...
/**
 * Basic UI delegate for JdbTableScrollBar component with special
 * enhancements:
 ...
 */
public class BasicJdbTableScrollBarUI extends BasicScrollBarUI {
...
//    super.scrollByBlock(direction);
    synchronized (scrollbar) {
      ...
      if (scrollbar.getUnitIncrement(direction) != 0) {
    ...
    public void mouseDragged(MouseEvent e) {
      ...
      if (thumbPos == thumbMax) {
        ...
        if (tableScrollBar.isPaintDuringDrag()) {
          ...
          if (getScrollBar().getUnitIncrement(1) != 0) {
